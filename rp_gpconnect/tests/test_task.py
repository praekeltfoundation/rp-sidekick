...
class ProcessContactImportTaskTests(TestCase):
    def setUp(self):
        self.org = Organization.objects.create(
            name="Test Organization", url="http://localhost:8002/",
            token="REPLACEME"
        )
    ...
    def test_contact_import_skips_if_no_wa_id(self,
        ...
        mock_get_whatsapp_contact_id.assert_called_with(self.org,
                                                        '+27723456789')
    ...
    def test_contact_import_if_contact_exists(self,
                                              mock_get_whatsapp_contact_id,
                                              mock_get_rp_contact,
        ...
        mock_get_rp_contact.return_value.first.return_value = \
            mock_contact_object
    ...
    @patch("temba_client.v2.TembaClient.get_contacts", autospec=True)
    @patch("rp_gpconnect.tasks.get_whatsapp_contact_id", autospec=True)
    def test_contact_import_if_new_contact(self,
                                           mock_get_whatsapp_contact_id,
                                           mock_get_rp_contact,
                                           mock_update_rp_contact,
                                           mock_create_rp_contact):
        ...
        assertCallMadeWith(mock_create_rp_contact.call_args,
                           urns=["tel:+27723456789", "whatsapp:27723456789"])
